...
var loadedPluginId = '';
var CommonNinjaPlugin = function (props) {
    var pluginId = props.pluginId, type = props.type, onLoad = props.onLoad, muteEvents = props.muteEvents, pluginProps = props.pluginProps;
    var _a = require$$0.useState(!!document.getElementById('commonninja-sdk')), scriptLoaded = _a[0], setScriptLoaded = _a[1];
    ...
    return (jsxRuntime.exports.jsx("div", __assign({ className: "commonninja_component", "comp-type": type, "comp-id": pluginId }, conditionalProps), void 0));
};

exports.CommonNinjaPlugin = CommonNinjaPlugin;
